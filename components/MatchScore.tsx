        ...
        <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 animate-fade-in">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white">Your Resume Analysis is Ready</h1>
                    <p className="mt-2 text-lg text-gray-600 dark:text-gray-300">{analysis.summary}</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="lg:col-span-2 bg-gray-50 dark:bg-gray-900/50 p-6 rounded-lg">
                    ...
                    {isQualified ? (
                        hasCredits ? (
                            <>
                             ...
                             <div className="max-w-2xl mx-auto bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
                                ...
                                <p className="mt-2 text-blue-700 dark:text-blue-300">
                                 ...
                                 <button
                                    onClick={onPurchase}
                                    className="mt-4 bg-primary-600 text-white font-bold py-2 px-6 rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 transition-all duration-300"
                                >
                        ...
                        <div className="max-w-2xl mx-auto bg-red-50 dark:bg-red-900/20 p-6 rounded-lg border border-red-200 dark:border-red-800">
                            ...
                            <p className="mt-2 text-red-700 dark:text-red-300">
                             ...
                             <button
                                onClick={onReupload}
                                className="mt-4 bg-gray-700 text-white font-bold py-2 px-6 rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 transition-all duration-300"
                            >
